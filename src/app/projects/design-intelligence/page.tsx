        ...
        <main className="w-full max-w-[1440px] px-8 md:px-[60px] pt-28 md:pt-36 pb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 pb-12 border-b border-[var(--theme-border)]">
            {[
              ...
              <div key={label} className="flex flex-col gap-4">
                <span className="text-[12px] uppercase tracking-[0.14em] font-bold opacity-50 text-[var(--theme-text-lo)]">
                  {label}
                </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-8 gap-y-16 mt-20 md:mt-32">
            ...
            <div className="col-span-1 lg:col-span-9 flex flex-col pt-2 lg:pt-0">
              ...
              <div id="summary" className="scroll-mt-32">
                <div className="grid grid-cols-1 md:grid-cols-11 gap-x-8 gap-y-12 mb-16 lg:ml-2">
                  <div className="col-span-1 md:col-span-5 lg:col-span-4 flex flex-col">
                    <h2 className="text-[32px] md:text-[36px] font-medium mb-3 tracking-tight text-[var(--theme-text-hi)]">
                      Summary
                    </h2>
                  ...
                  <div className="col-span-1 md:col-span-6 lg:col-span-7 flex flex-col gap-8 lg:pl-12">
                    <p className="text-[16px] leading-[1.7] md:w-[95%] text-[var(--theme-text-mid)]">
                      Most design tools today focus on creation, but reviewing designs often happens later or through plugins.
                    </p>
                    <p className="text-[16px] leading-[1.7] md:w-[95%] text-[var(--theme-text-mid)]">
                      This concept introduces Design Intelligence, a system that works alongside designers, automatically detecting issues, suggesting improvements, and maintaining consistency in real time.
                    </p>
                ...
                <div className="w-full flex justify-center mb-16">
                  <Image src="/images/Project 2 - Design Intelligence Case study Images/Summary - DI.png" alt="Summary mockup" width={1000} height={700} className="w-auto max-h-[700px] object-contain rounded-[24px]" />
                </div>
              </div>
              ...
              <div
                id="problem"
                className="scroll-mt-32 flex flex-col items-center mt-32 mb-16"
              >
                <h2 className="text-[32px] md:text-[40px] font-medium mb-3 tracking-tight text-[var(--theme-text-hi)]">
                  The Problem
                </h2>
                ...
                <p className="text-[18px] leading-[1.65] text-center max-w-[820px] mb-20 text-[var(--theme-text-lo)]">
                  Design tools prioritize creation, but reviewing quality still depends on manual checks
                  <br className="hidden md:block" /> or plugins, which interrupts flow and delays feedback.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-20">
                  <div className="flex flex-col border rounded-[20px] p-2 hover:opacity-80 transition-opacity bg-[var(--theme-surface)] border-[var(--theme-border)]">
                    <div className="w-full aspect-[4/3] rounded-[12px] mb-4 relative overflow-hidden">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Problem - 1.png" alt="Missed Design Issues" fill className="object-cover" />
                    </div>
                    <div className="px-2 pb-2 flex flex-col">
                      ...
                      <p className="text-[15px] leading-[1.65] text-[var(--theme-text-lo)]">
                        Small inconsistencies like spacing, contrast, or alignment often remain unnoticed during the design process.
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col border rounded-[20px] p-2 hover:opacity-80 transition-opacity bg-[var(--theme-surface)] border-[var(--theme-border)]">
                    <div className="w-full aspect-[4/3] rounded-[12px] mb-4 relative overflow-hidden">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Problem - 2.png" alt="Fragmented Workflow" fill className="object-cover" />
                    </div>
                    <div className="px-2 pb-2 flex flex-col">
                      <h3 className="text-[16px] font-medium mb-3 text-[var(--theme-text-hi)]">
                        Fragmented Workflow
                      ...
                      <p className="text-[15px] leading-[1.65] text-[var(--theme-text-lo)]">
                        Switching between designing and plugins breaks focus and adds unnecessary steps to the workflow.
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col border rounded-[20px] p-2 hover:opacity-80 transition-opacity bg-[var(--theme-surface)] border-[var(--theme-border)]">
                    <div className="w-full aspect-[4/3] rounded-[12px] mb-4 relative overflow-hidden">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Problem - 3.png" alt="Delayed Feedback" fill className="object-cover" />
                    </div>
                    <div className="px-2 pb-2 flex flex-col">
                      <h3 className="text-[16px] font-medium mb-3 text-[var(--theme-text-hi)]">
                        Delayed Feedback
                      ...
                      <p className="text-[15px] leading-[1.65] text-[var(--theme-text-lo)]">
                        Issues are identified after completion, leading to rework and slower iteration cycles.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14 mb-16">
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-[16px] leading-[1.7] text-[var(--theme-text-lo)]">
                      Designers focus on building interfaces, not constantly reviewing them. This creates gaps where small issues go unnoticed, especially in fast-paced workflows involving multiple screens and components.
                    </p>
                  </div>
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[16px] font-medium tracking-wide text-[var(--theme-text-hi)]">
                    ...
                    <p className="text-[16px] leading-[1.7] text-[var(--theme-text-lo)]">
                      Product and UI designers working on complex flows, managing multiple screens, components, and systems, where maintaining consistency and catching small issues becomes difficult during active design work.
                    </p>
                  </div>
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[16px] font-medium tracking-wide text-[var(--theme-text-hi)]">
                    ...
                    <p className="text-[16px] leading-[1.7] text-[var(--theme-text-lo)]">
                      Shift the experience from manual review to real-time guidance by embedding feedback directly into the design environment, allowing designers to identify and resolve issues instantly without switching.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 w-full">
                  <div className="flex flex-col gap-6">
                    <div className="w-full aspect-[4/3] rounded-[24px] relative border border-[var(--theme-border)] p-3">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI User Research - Research Approach - 1.png" alt="Research Approach" fill className="object-cover rounded-[16px]" />
                    </div>
                    <div className="flex flex-col gap-2 px-1">
                      <h4 className="text-[16px] font-medium text-[var(--theme-text-hi)]">Research Approach</h4>
                      <p className="text-[14px] leading-[1.65] text-[var(--theme-text-lo)]">Focused on understanding where designers lose attention and how delayed feedback impacts design quality.</p>
                    </div>
                  </div>
                  <div className="flex flex-col gap-6">
                    <div className="w-full aspect-[4/3] rounded-[24px] relative border border-[var(--theme-border)] p-3">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI User Research - Intelligence oppurtunity - 2.png" alt="Intelligence Opportunity" fill className="object-cover rounded-[16px]" />
                    </div>
                    <div className="flex flex-col gap-2 px-1">
                      <h4 className="text-[16px] font-medium text-[var(--theme-text-hi)]">Intelligence Opportunity</h4>
                      <p className="text-[14px] leading-[1.65] text-[var(--theme-text-lo)]">This enables tools to move from passive interfaces to active systems that assist designers while decisions are being made.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <p className="text-[16px] leading-[1.7] max-w-[700px] mb-20 text-[var(--theme-text-lo)]">
                  Designers don&apos;t ignore issues, they simply don&apos;t see them at the right moment. Most problems surface too late, after the design is already built.
                </p>
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <div
                      key={p}
                      className="px-4 py-2.5 rounded-[100px] border text-[13px] font-medium cursor-default select-none whitespace-nowrap hover:opacity-80 transition-opacity border-[var(--theme-border)] text-[var(--theme-text-lo)]"
                    >
                      {p}
                    </div>
                  ))}
                ...
                <div className="flex flex-col gap-24">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col">
                      <h3 className="text-[22px] font-medium mb-4 tracking-tight text-[var(--theme-text-hi)]">
                        Guided Design Awareness
                      </h3>
                      <p className="text-[16px] leading-[1.6] mb-6 text-[var(--theme-text-lo)]">
                        Surfaces issues directly on the canvas as they occur, making problems visible in the moment.
                      </p>
                      <ul className="flex flex-col gap-3.5 pl-1">
                        {["Detects spacing, contrast, and structure", "Highlights issues in context", "Brings hidden problems into focus", "Removes separate review steps", "Fixes issues during creation"].map((li) => (
                    ...
                    <div className="w-full aspect-[4/3] relative rounded-[16px] overflow-hidden border border-[var(--theme-border)] p-2">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Design concept - 1.png" alt="Guided Design Awareness" fill className="object-cover rounded-[8px]" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col">
                      ...
                      <p className="text-[16px] leading-[1.6] mb-6 text-[var(--theme-text-lo)]">
                        Embeds accessibility checks into the workflow, enabling instant corrections without context switching.
                      </p>
                      <ul className="flex flex-col gap-3.5 pl-1">
                        {["Flags low contrast instantly", "Suggests accessible color options", "Enables one-click fixes", "Aligns with accessibility standards", "Removes external tool dependency"].map((li) => (
                          <li key={li} className="flex items-center gap-3 text-[14px] leading-none text-[var(--theme-text-lo)]">
                            <div className="w-1.5 h-1.5 rounded-sm shrink-0 bg-[var(--theme-accent)]"></div>
                            {li}
                          </li>
                    ...
                    <div className="w-full aspect-[4/3] relative rounded-[16px] overflow-hidden border border-[var(--theme-border)] p-2">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Design concept - 2.png" alt="In-Flow Accessibility Checks" fill className="object-cover rounded-[8px]" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col">
                      ...
                      <p className="text-[16px] leading-[1.6] mb-6 text-[var(--theme-text-lo)]">
                        Maintains consistency by detecting deviations and guiding designs back to system-defined components.
                      </p>
                      <ul className="flex flex-col gap-3.5 pl-1">
                        {["Flags detached components", "Suggests system reconnection", "Prevents visual inconsistencies", "Reinforces system usage", "Keeps designs aligned"].map((li) => (
                          <li key={li} className="flex items-center gap-3 text-[14px] leading-none text-[var(--theme-text-lo)]">
                            <div className="w-1.5 h-1.5 rounded-sm shrink-0 bg-[var(--theme-accent)]"></div>
                            {li}
                          </li>
                    ...
                    <div className="w-full aspect-[4/3] relative rounded-[16px] overflow-hidden border border-[var(--theme-border)] p-2">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Design concept - 3.png" alt="Design System Integrity" fill className="object-cover rounded-[8px]" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col">
                      ...
                      <p className="text-[16px] leading-[1.6] mb-6 text-[var(--theme-text-lo)]">
                        Ensures complete user journeys by identifying gaps in navigation and interaction.
                      </p>
                      <ul className="flex flex-col gap-3.5 pl-1">
                        {["Detects broken flows", "Flags orphan screens", "Suggests next connections", "Maintains navigation continuity", "Reduces flow errors early"].map((li) => (
                          <li key={li} className="flex items-center gap-3 text-[14px] leading-none text-[var(--theme-text-lo)]">
                            <div className="w-1.5 h-1.5 rounded-sm shrink-0 bg-[var(--theme-accent)]"></div>
                            {li}
                          </li>
                    ...
                    <div className="w-full aspect-[4/3] relative rounded-[16px] overflow-hidden border border-[var(--theme-border)] p-2">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Design concept - 4.png" alt="Connection Intelligence" fill className="object-cover rounded-[8px]" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col">
                      ...
                      <p className="text-[16px] leading-[1.6] mb-6 text-[var(--theme-text-lo)]">
                        Turns design quality into a measurable signal that evolves with the product.
                      </p>
                      <ul className="flex flex-col gap-3.5 pl-1">
                        {["Tracks issues and improvements", "Shows design health score", "Compares iterations easily", "Supports faster decisions", "Makes quality visible"].map((li) => (
                          <li key={li} className="flex items-center gap-3 text-[14px] leading-none text-[var(--theme-text-lo)]">
                            <div className="w-1.5 h-1.5 rounded-sm shrink-0 bg-[var(--theme-accent)]"></div>
                            {li}
                          </li>
                    ...
                    <div className="w-full aspect-[4/3] relative rounded-[16px] overflow-hidden border border-[var(--theme-border)] p-2">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Design concept - 5.png" alt="Design Health Visibility" fill className="object-cover rounded-[8px]" />
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="flex flex-col">
                    ...
                    <p className="text-[16px] leading-[1.7] max-w-[400px] text-[var(--theme-text-lo)]">
                      Initial validation explored how real-time feedback influences designer behaviour during active workflows.
                    </p>
                  </div>
                  <div className="flex flex-col gap-6">
                    ...
                    <p className="text-[16px] leading-[1.7] text-[var(--theme-text-lo)]">
                      Designers responded well to immediate insights, as they reduced reliance on plugins and allowed issues to be fixed instantly, maintaining flow and making the overall design process more efficient and focused.
                    </p>
                    <p className="text-[16px] leading-[1.7] text-[var(--theme-text-lo)]">
                      Designers also showed improved confidence in their decisions, as feedback was available at the right moment. This reduced hesitation and allowed them to move forward without second-guessing their design choices.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-4">
                  <div className="w-full aspect-[4/3] rounded-[24px] overflow-hidden border border-[var(--theme-border)] relative p-3">
                    <Image src="/images/Project 2 - Design Intelligence Case study Images/DI User Testing - 1.png" alt="Testing 1" fill className="object-contain rounded-[16px]" />
                  </div>
                  <div className="w-full aspect-[4/3] rounded-[24px] overflow-hidden border border-[var(--theme-border)] relative p-3">
                    <Image src="/images/Project 2 - Design Intelligence Case study Images/DI User Testing - 2.png" alt="Testing 2" fill className="object-contain rounded-[16px]" />
                  </div>
                </div>
              </div>
              ...
              <div id="snippets" className="scroll-mt-32 mt-24 mb-16 lg:ml-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                  <div className="flex flex-col gap-4">
                    <div className="w-full aspect-[4/3] rounded-[24px] overflow-hidden border border-[var(--theme-border)] relative p-3">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Before.png" alt="Before" fill className="object-contain rounded-[16px]" />
                    </div>
                    <span className="text-[14px] text-[var(--theme-text-lo)]">Before</span>
                  </div>
                  <div className="flex flex-col gap-4">
                    <div className="w-full aspect-[4/3] rounded-[24px] overflow-hidden border border-[var(--theme-border)] relative p-3">
                      <Image src="/images/Project 2 - Design Intelligence Case study Images/DI After.png" alt="After" fill className="object-contain rounded-[16px]" />
                    </div>
                ...
                <div className="w-full aspect-[16/9] md:aspect-[2/1] rounded-[24px] overflow-hidden border border-[var(--theme-border)] relative p-3">
                  <Image src="/images/Project 2 - Design Intelligence Case study Images/DI Design Explorations.png" alt="Design Explorations" fill className="object-cover rounded-[16px]" />
                </div>
              </div>
          ...
          <div className="w-full mt-32 border-t border-[var(--theme-border)] pt-20 pb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { name: "Budgeting App", href: "/projects/budgeting-app", img: "/images/Project 3 - Finance app Case Study Images/Summary - PW.png" },
